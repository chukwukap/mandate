...
import { type Abi, type AbiFunction, type Hex, parseAbi, toFunctionSelector } from "viem";
import {
  aggregatorV3Abi,
 ...
 * clients/base.ts and apps/worker/src/chain.ts, and a one-sided edit to any of them diverges
 * silently and only fails on Base mainnet. So rather than trusting the copies, this test reads
 * the other files' source and compares the encodings they actually produce.
 */
