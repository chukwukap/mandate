 ...
 * pool with the balance it holds on mainnet, and fund the local test account.
 *
...
/** anvil #0 deploys, anvil #1 is the test login wallet. */
...
// This is an Anvil fixture account. Browser tests fund their Privy embedded address
// separately through fork-fund.sh after login; no spender wallet is created.
...
console.log(`test account ${account} funded with 10,000 USDC and 10 ETH`);
